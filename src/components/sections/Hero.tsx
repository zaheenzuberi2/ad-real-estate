      ...
      <div className="shell relative z-10 pb-16 pt-14 sm:pb-20 sm:pt-24 lg:pb-24 lg:pt-32">
        <div className="flex flex-col lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(0,21rem)] lg:items-center lg:gap-14">
          ...
          <div className="order-1 max-w-[36rem]">
            ...
            <p className="mt-5 max-w-[44ch] text-[0.95rem] leading-relaxed text-slate-300 sm:mt-6 sm:text-lg">
              Islamabad&apos;s most guarded address, navigated for you by a team
              that has handled site visits, title verification and transfer of
              possession for families and overseas investors &mdash; from the
              first call to the last signature.
            </p>
