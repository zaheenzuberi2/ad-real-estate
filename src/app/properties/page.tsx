...
export const metadata: Metadata = {
  ...
  description:
    "Browse verified plots, villas and commercial units for sale across DHA, Islamabad-Rawalpindi. Every listing title-checked before it reaches you.",
  alternates: { canonical: "/properties" },
  openGraph: {
    title: "Plots & Property for Sale in DHA, Islamabad-Rawalpindi",
    description:
      "Browse verified plots, villas and commercial units for sale across DHA, Islamabad-Rawalpindi.",
      ...
      <section className="bg-navy-deep pb-14 pt-16">
        <div className="shell">
          ...
          <h1 className="mt-4 max-w-3xl font-display text-4xl font-medium leading-tight text-white sm:text-5xl">
            Plots &amp; Property for Sale in DHA, Islamabad-Rawalpindi
          </h1>
